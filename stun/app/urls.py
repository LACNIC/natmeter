...
reports = patterns(
    ...
    url(r'nat_free_6_true', views.generic_reports, {'nat_free_6': True}, name='report_nat_free_6_true'),
    url(r'nat_free_6_false', views.generic_reports, {'nat_free_6': False}, name='report_nat_free_6_false'),
